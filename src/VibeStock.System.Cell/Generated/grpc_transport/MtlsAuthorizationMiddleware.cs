...
public class MtlsAuthorizationMiddleware
{
    ...
    private static readonly string[] AllowedCallers = new[] { "spiffe://saasfoundry/vibestock/core.cell", "spiffe://saasfoundry/vibestock/ingestor.cell", "spiffe://saasfoundry/vibestock/bridge.cell" };
