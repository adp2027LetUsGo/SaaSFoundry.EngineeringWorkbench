...
namespace SaaSFoundry.Plugins.AI;

public sealed class AIPlugin : IPluginMetadataProvider
{
    private readonly IPluginMetadataProvider _innerPlugin;

    public AIPlugin() : this(null) { }

    public AIPlugin(IEnumerable<IPluginCapability>? injectedCapabilities)
    {
        ...
        _innerPlugin = new PluginBuilder()
            .WithIdentity("ai", "1.0.0", "SaaSFoundry Engineering", "SHA256:00000")
            .WithManifest("AI Foundation Plugin", "AI Foundation Plugin", "SaaSFoundry.EngineeringWorkbench v1.0", "net10.0", "v1.0.0", "NativeAOT")
