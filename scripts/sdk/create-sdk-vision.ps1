# ============================================================================
# SaaSFoundry SDK
# Script: create-sdk-vision.ps1
# Purpose: Orchestrates complete generation of the SDK Vision document.
# Version: 1.0
# ============================================================================
...
$parts=@(
"create-sdk-vision-part1.ps1",
"create-sdk-vision-part2.ps1",
"create-sdk-vision-part3.ps1"
)
...
if(!(Test-Path $OutputFile)){
    throw "SDK Vision document was not generated."
}
