# ============================================================================
# SaaSFoundry SDK
# Script: create-sdk-engineering-knowledge.ps1
# Purpose: Orchestrates complete generation of the SDK Engineering Knowledge.
# Version: 1.0
# ============================================================================
...
$parts=@(
"create-sdk-engineering-knowledge-part1.ps1",
"create-sdk-engineering-knowledge-part2.ps1",
"create-sdk-engineering-knowledge-part3.ps1"
)
...
if(!(Test-Path $OutputFile)){
    throw "SDK Engineering Knowledge document was not generated."
}
