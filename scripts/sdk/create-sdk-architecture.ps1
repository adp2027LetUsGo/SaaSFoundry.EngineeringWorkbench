# ============================================================================
# SaaSFoundry SDK
# Script: create-sdk-architecture.ps1
# Purpose: Orchestrates complete generation of the SDK Architecture document.
# Version: 1.0
# ============================================================================
...
$parts=@(
"create-sdk-architecture-part1.ps1",
"create-sdk-architecture-part2.ps1",
"create-sdk-architecture-part3.ps1"
)
...
if(!(Test-Path $OutputFile)){
    throw "SDK Architecture document was not generated."
}
